...
betamap=np.empty(hp.nside2npix(512))

for ii in range(hp.nside2npix(512)):
    betamap[ii]=np.log10(hi_corrected[ii]/low[ii])/np.log10(hi_freq/low_freq)

betamap_out=coeffs_in.rsplit('.',1)[0]+'spec_index_pix.fits'

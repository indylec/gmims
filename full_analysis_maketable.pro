...
pro full_analysis_maketable,infile,goodfraction,endchans,x1,x2,y1,y2,averagefile,bgfile,outplot,rippleplot
...
plot,fgood_frac,onesub_medians,yrange=[-0.1,0.4],psym=1,subtitle=name+' Raw(red), 1 sub (black) & 2 subs(green)',xtitle='Frequency channel',ytitle='Median value (K)',xstyle=8,ymargin=[6,4]
...
plot,fgood_frac,good_sub_medians,psym=1,subtitle='Median brightness of background map',xtitle='frequency channel',ytitle='Median brightness (K)',xstyle=8,ymargin=[6,4]
axis,xaxis=1,xrange=(!X.CRANGE-refpix)*df+f0,xstyle=1,xtitle= 'Frequency (Hz)',xcharsize=0.9
device, /close
